...
public class ControlFlowNodes {
    ...
    public static void register() {
        ...
        NodeHelper.setup("branch", "node.mgmc.branch.name")
            ...
            .description("node.mgmc.branch.desc")
        ...
        NodeHelper.setup("switch", "node.mgmc.switch.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.switch.desc")
        ...
        NodeHelper.setup("for_loop", "node.mgmc.for_loop.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.for_loop.desc")
        ...
        NodeHelper.setup("wait_tick", "node.mgmc.wait_tick.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.wait_tick.desc")
        ...
        NodeHelper.setup("wait_s", "node.mgmc.wait_s.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.wait_s.desc")
        ...
        NodeHelper.setup("timer_start", "node.mgmc.timer_start.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.timer_start.desc")
        ...
        NodeHelper.setup("timer_stop", "node.mgmc.timer_stop.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.timer_stop.desc")
        ...
        NodeHelper.setup("timer_reset", "node.mgmc.timer_reset.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.timer_reset.desc")
        ...
        NodeHelper.setup("timer_get", "node.mgmc.timer_get.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.timer_get.desc")
        ...
        NodeHelper.setup("break_loop", "node.mgmc.break_loop.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.break_loop.desc")
        ...
        NodeHelper.setup("call_blueprint", "node.mgmc.call_blueprint.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.call_blueprint.desc")
        ...
        NodeHelper.setup("return_to_caller", "node.mgmc.return_to_caller.name")
            .category("node_category.mgmc.logic.control")
            .color(NodeThemes.COLOR_NODE_CONTROL)
            .description("node.mgmc.return_to_caller.desc")
